...
function sms_handle_step1() {
    ...
    // CORRECCIÓN CRÍTICA: Limpiar teléfono de espacios y caracteres raros ANTES de guardar
    ...
    $data = [
        ...
        'client_phone' => $clean_phone, // Guardamos limpio
        'client_email' => $email,
...
// SHORTCODE Perfil Público (Sin cambios, se mantiene funcional)
